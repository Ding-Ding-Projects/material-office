...
const SURFACES = [
  ...
  },
  {
    ...
    behaviorEn: "Writer provides an editable rich-text page, headings, lists, alignment, basic inline formatting, word count, autosave, and honest HTML export.",
  ...
  },
  {
    ...
    behaviorEn: "History lists app-owned workspace snapshots, filters them, exports selected data, and restores a validated state as a new revision. A reviewed prune keeps the newest snapshots and permanently removes older unreachable history without changing the current workspace.",
